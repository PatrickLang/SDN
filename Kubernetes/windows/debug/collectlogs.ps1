...
if (!(Test-Path $helper))
{
    Invoke-WebRequest -UseBasicParsing https://raw.githubusercontent.com/PatrickLang/SDN/patch-1-temp/Kubernetes/windows/helper.psm1 -OutFile $BaseDir\helper.psm1
}
ipmo $helper
